...
//"we considered of how we could make it more user friendly by looking at it from the user's POV, the colour will be a fast way for the user to see the risk level."
